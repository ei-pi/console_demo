class Game {
    ...
    static getInstance(): Game { return this.#instance ??= (Game.#constructing = true, new Game()); }
    ...
    #update() {
        const can = this.#canvas,
            ...
            now = Date.now(),
            deltaTime = now - this.#currentUpdate;
